...
/**
 * @author lin
 * @date 2018年10月30日 上午10:11:09
 */
public class SerialNumberUtil {
	/** 自定义进制（选择你想要的进制数，不能重复且最好不要0、1这些容易混淆的字符） */
	private static final char[] r = new char[] { 'q', 'w', 'e', '8', 's', '2', 'd', 'z',
	...
	public static void main(String[] args) {
		...
		int count = 1;
		while(count<=10000000){ //1千W次
			set.add(toSerialCode(id));
			id++;
			count++;
		}
		System.out.println("生成不重复Set集合:"+set.size());*/
	}
